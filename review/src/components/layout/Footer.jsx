          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Electric Road, Power City, PC 12345</span>
              </li>
              <li className="flex items-center">
                <Phone size={20} className="mr-2 text-brand-purple flex-shrink-0" />
                <a href="tel:+1234567890" className="text-gray-400 hover:text-brand-purple">+123 456 7890</a>
              </li>
              <li className="flex items-center">
                <Mail size={20} className="mr-2 text-brand-purple flex-shrink-0" />
                <a href="mailto:info@srelectricals.com" className="text-gray-400 hover:text-brand-purple">info@srelectricals.com</a>
              </li>
            </ul>
          </div>
        </div>
