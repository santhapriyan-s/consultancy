        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/profile" element={<Layout><ProfilePage /></Layout>}>
              ...
              <Route path="addresses" element={<div className="bg-white p-8 rounded-lg shadow-sm"><h2 className="text-2xl font-semibold mb-4">Manage Addresses</h2><p>This section is under development.</p></div>} />
              <Route path="gift-cards" element={<div className="bg-white p-8 rounded-lg shadow-sm"><h2 className="text-2xl font-semibold mb-4">Gift Cards</h2><p>This section is under development.</p></div>} />
              <Route path="upi" element={<div className="bg-white p-8 rounded-lg shadow-sm"><h2 className="text-2xl font-semibold mb-4">Saved UPI</h2><p>This section is under development.</p></div>} />
              ...
              <Route path="coupons" element={<div className="bg-white p-8 rounded-lg shadow-sm"><h2 className="text-2xl font-semibold mb-4">My Coupons</h2><p>This section is under development.</p></div>} />
            </Route>
