      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between">
          ...
          {activeStep === steps.length - 1 ? (
            ...
            >
              Place Order <CheckCircle size={18} className="ml-1" />
            </button>
          ) : (
            <button
              onClick={handleNext}
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div className="border border-gray-200 rounded-lg p-4 cursor-pointer hover:border-brand-purple transition-colors">
          ...
          {paymentMethod === 'card' && (
            <div className="mt-4 space-y-4 pl-8">
              ...
              <div>
                <label htmlFor="nameOnCard" className="block text-gray-700 font-medium mb-1">
                  Name on Card
                </label>
                <input
                  type="text"
