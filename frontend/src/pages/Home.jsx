    ...
    <div>
      ...
      <section className="hero-section py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('welcomeMessage')}</h1>
            <p className="text-xl mb-8">{t('heroSubtitle')}</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/products">
                <Button className="bg-srblue hover:bg-blue-700 text-white px-8 py-2 text-lg">
                  {t('shopNow')}
                </Button>
              </Link>
              <Link to="/about">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <div className="bg-srblue h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">{t('deliveryDescription')}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">{t('safeReliable')}</h3>
              <p className="text-gray-600">{t('safeDescription')}</p>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-10">
            ...
            <Link to="/products" className="text-srblue hover:text-blue-700 flex items-center">
              {t('viewMore')}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {['lighting', 'wiring', 'switches', 'safety', 'solar', 'tools'].map((category) => (
              <Link 
                ...
                key={category}
                className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-all hover:-translate-y-1"
              >
      ...
      <section className="bg-srblue text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/products">
            <Button variant="outline" className="bg-white text-srblue hover:bg-gray-100 hover:text-blue-700 px-8 py-2 text-lg">
              {t('shopNow')}
            </Button>
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                "SR Electricals has the best quality products I've found. Their LED bulbs last much longer than any other brand I've tried."
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="stars mb-4">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span key={star} className={`star ${star === 5 ? 'empty' : ''}`}>★</span>
                ))}
              </div>
              <p className="text-gray-600 mb-4">
                "Great service and fast delivery. I ordered a voltage stabilizer on Monday and received it by Wednesday. Works perfectly!"
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                "The smart plugs I purchased are fantastic! Easy to set up and the app works perfectly. Will definitely shop here again."
              </p>
